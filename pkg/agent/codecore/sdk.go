...
func (s *SDK) CreateAgentSession(opts CreateAgentSessionOptions) (*CreateAgentSessionResult, error) {
...
func (s *SDK) RunSession(opts CreateAgentSessionOptions, prompt string) ([]agent.AgentMessage, error) {
